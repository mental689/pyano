function instructions(job, h)
{
    ...
    h.append("<img src='/static/img/vatic/box.jpg' align='right'>");
    ...
    h.append("<img src='/static/img/vatic/classify.jpg' align='right'>");
    ...
    h.append("<img src='/static/img/vatic/outsideoccluded.jpg' align='right'>");
    ...
    h.append("<p>If there are many objects on the screen, it can become difficult to select the right bounding box. By pressing the lock button <img src='/static/img/vatic/lock.jpg'> on an object's sidebar rectangle, you can prevent changes to that track. Press the lock button again to renable modifications.</p>");
    ...
    //h.append("<img src='/static/img/vatic/secret.png'>");
    //h.append("<img src='/static/img/vatic/everyobject.jpg'>");
    ...
    h.append("<table><tr><td><img src='/static/img/vatic/tight-good.jpg'></td><td><img src='/static/img/vatic/tight-bad.jpg'></td></tr><tr><th>Good</th><th>Bad</th></tr></table>");
    ...
    h.append("<img src='/static/img/vatic/sequence1.jpg'> ");
    h.append("<img src='/static/img/vatic/sequence3.jpg'> ");
    h.append("<img src='/static/img/vatic/sequence4.jpg'><br>");
    ...
    h.append("<img src='/static/img/vatic/entering1.png'> <img src='/static/img/vatic/entering2.png'> <img src='/static/img/vatic/entering3.png'> <img src='/static/img/vatic/entering4.png'><br>");
    ...
    h.append("<img src='/static/img/vatic/outofcar1.png'> <img src='/static/img/vatic/outofcar2.png'> <img src='/static/img/vatic/outofcar3.png'> <br>");
